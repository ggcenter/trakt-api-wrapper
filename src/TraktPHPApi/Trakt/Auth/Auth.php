...
use TraktPHPApi\Trakt\Exception\InvalidOauthRequestException;

class Auth
{
    /**
     * @var \TraktPHPApi\Trakt\Auth\TraktProvider
     */
    public $provider;
     ...
     * @throws \TraktPHPApi\Trakt\Exception\InvalidOauthRequestException
     */
