...
namespace TraktPHPApi\Trakt\Console\Generators;
...
use TraktPHPApi\Trakt\Exception\ClassCanNotBeImplementedAsEndpointException;
use TraktPHPApi\Trakt\Request\AbstractRequest;

/**
 * Class ClassGenerator
 * @package TraktPHPApi\Trakt\Console\Generators
 */
class EndpointGenerator
{
     ...
     * @var string
     */
    private $apiNamespace = "TraktPHPApi\\Trakt\\Api";

    /**
     * @var string
     */
    private $requestsNamespace = "TraktPHPApi\\Trakt\\Request\\";
     ...
     * @return \TraktPHPApi\Trakt\Console\Generators\Method
     * @throws \TraktPHPApi\Trakt\Exception\ClassCanNotBeImplementedAsEndpointException
